...
const Billing = () => (
  <section id="product" className={ layout.sectionReverse }>
    ...
    <div className={ layout.sectionInfo }>
      <h2 className={ styles.heading2 }>Easily control your <br className="sm:block hidden" /> billuing & invoicing.</h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>orem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat distinctio nihil doloribus quam enim laborum? Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium ea ut pariatur enim incidunt consequuntur.</p>
